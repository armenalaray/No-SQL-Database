internal void CreateOpcodeIDS_32(file_manager * FileManager)
{
	...
	BeginFileSection(FileManager, FileSection_bits_32);
	...
	BeginInstructionBits(FileManager);
	CopyBitsToFile(FileManager, BitsIDFile(8,0x27));
	EndInstructionBits(FileManager);
	...
	BeginInstructionBits(FileManager);
	CopyBitsToFile(FileManager, BitsIDFile(5,0x08));
	CopyBitsToFile(FileManager, reg);
	EndInstructionBits(FileManager);

	BeginInstructionBits(FileManager);
	CopyBitsToFile(FileManager, BitsIDFile(5,0x09));
	CopyBitsToFile(FileManager, reg);
	EndInstructionBits(FileManager);
