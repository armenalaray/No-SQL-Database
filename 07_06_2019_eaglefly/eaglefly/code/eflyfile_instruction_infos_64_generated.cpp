internal void CreateInstructionInfos_64(file_manager * FileManager)
{

	operand_array OperandArray = {};
	BeginFileSection(FileManager, FileSection_instruction_info_64);
	...
	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_Z,OperandSize_vq);
	PushInstructionInfo(FileManager, "PUSH", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	PushInstructionInfo(FileManager, "MOVSXD", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_E,OperandSize_vq);
	PushInstructionInfo(FileManager, "POP", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_E,OperandSize_q);
	PushInstructionInfo(FileManager, "CALL", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_R,OperandSize_vqp);
	PushInstructionInfo(FileManager, "SLDT", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_R,OperandSize_vqp);
	PushInstructionInfo(FileManager, "STR", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_E,OperandSize_w);
	PushInstructionInfo(FileManager, "LLDT", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);

	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_E,OperandSize_w);
	PushInstructionInfo(FileManager, "LTR", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);

	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_E,OperandSize_w);
	PushInstructionInfo(FileManager, "VERR", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);

	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_E,OperandSize_w);
	PushInstructionInfo(FileManager, "VERW", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushInstructionInfo(FileManager, "VMCALL", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);

	InitOperandArray(&OperandArray);
	PushInstructionInfo(FileManager, "VMLAUNCH", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);

	InitOperandArray(&OperandArray);
	PushInstructionInfo(FileManager, "VMRESUME", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);

	InitOperandArray(&OperandArray);
	PushInstructionInfo(FileManager, "VMXOFF", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushInstructionInfo(FileManager, "SWAPGS", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_G,OperandSize_vqp);
	PushOperand(&OperandArray, OperandType_R,OperandSize_v);
	PushInstructionInfo(FileManager, "LAR", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	PushOperand(&OperandArray, OperandType_G,OperandSize_vqp);
	PushOperand(&OperandArray, OperandType_R,OperandSize_v);
	PushInstructionInfo(FileManager, "LSL", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushInstructionInfo(FileManager, "SYSCALL", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushInstructionInfo(FileManager, "SYSRET", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_H,OperandSize_q);
	PushOperand(&OperandArray, OperandType_C,OperandSize_q);
	PushInstructionInfo(FileManager, "MOV", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);

	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_H,OperandSize_q);
	PushOperand(&OperandArray, OperandType_D,OperandSize_q);
	PushInstructionInfo(FileManager, "MOV", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushInstructionInfo(FileManager, "SYSENTER", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);

	InitOperandArray(&OperandArray);
	PushInstructionInfo(FileManager, "SYSEXIT", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	PushOperand(&OperandArray, OperandType_M,OperandSize_dq);
	PushInstructionInfo(FileManager, "INVEPT", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_G,OperandSize_q);
	PushOperand(&OperandArray, OperandType_M,OperandSize_dq);
	PushInstructionInfo(FileManager, "INVEPT", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	PushOperand(&OperandArray, OperandType_G,OperandSize_d);
	PushOperand(&OperandArray, OperandType_M,OperandSize_dq);
	PushInstructionInfo(FileManager, "INVVPID", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_E,OperandSize_qp);
	PushOperand(&OperandArray, OperandType_V,OperandSize_dq);
	PushOperand(&OperandArray, OperandType_I,OperandSize_b);
	PushInstructionInfo(FileManager, "PEXTRQ", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	PushOperand(&OperandArray, OperandType_E,OperandSize_qp);
	PushOperand(&OperandArray, OperandType_I,OperandSize_b);
	PushInstructionInfo(FileManager, "PINSRQ", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	PushOperand(&OperandArray, OperandType_G,OperandSize_vqp);
	PushOperand(&OperandArray, OperandType_E,OperandSize_vqp);
	PushInstructionInfo(FileManager, "CMOVBE", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	PushOperand(&OperandArray, OperandType_E,OperandSize_q);
	PushOperand(&OperandArray, OperandType_G,OperandSize_q);
	PushInstructionInfo(FileManager, "VMREAD", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);

	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_G,OperandSize_q);
	PushOperand(&OperandArray, OperandType_E,OperandSize_q);
	PushInstructionInfo(FileManager, "VMWRITE", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_M,OperandSize_dq);
	PushInstructionInfo(FileManager, "CMPXCHG16B", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID,  LOCK_VALID, !BRANCHHINT_VALID);

	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_M,OperandSize_q);
	PushInstructionInfo(FileManager, "VMPTRLD", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);

	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_M,OperandSize_q);
	PushInstructionInfo(FileManager, "VMCLEAR", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_M,OperandSize_q);
	PushInstructionInfo(FileManager, "VMXON", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
	...
	InitOperandArray(&OperandArray);
	PushOperand(&OperandArray, OperandType_M,OperandSize_q);
	PushInstructionInfo(FileManager, "VMPTRST", OperandArray.Count, (u32*)OperandArray.TypesArray, (u32*)OperandArray.SizesArray, !REP_VALID, !LOCK_VALID, !BRANCHHINT_VALID);
